...
const Movies = (props) => {
    ...
    return (
        <main className="movies">
            ...
            {data.length === 0 ? <p className="not-found">No Movies Found</p> :
                <div className="boxes">
                    {movies}
                </div>}
        </main>
